...
public class CustomerDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dic.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        table2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CUSTOMER NAME", "FUEL NAME", "QUANTITY", "TOTAL PRICE", "PAYMENT METHOD"
            }
        ));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(59, 59, 59)
                        .addComponent(dic, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(222, 222, 222)
        ...
        setSize(new java.awt.Dimension(1109, 696));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
        cs=conn.prepareCall("{call getcustomerpaymentdetails(?)}");
        cs.setString(1,dic.getText());
        rs=cs.executeQuery();
        while(rs.next())
        {
